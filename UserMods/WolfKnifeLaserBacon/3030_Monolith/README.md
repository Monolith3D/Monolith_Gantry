...
💬 Monolith V-Core 3.1 User Mod Development Thread
...
Special thanks to the Monolith community on Discord and to CloakedWayne for the development of the Monolith gantry — the de facto solution for speed, simplicity, and quality.
